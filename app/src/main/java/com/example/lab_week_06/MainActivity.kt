    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        catAdapter.setData(
            listOf(
                ...
                CatModel(Gender.Male, CatBreed.AmericanCurl, "Leo", "Playful and active", "https://cdn2.thecatapi.com/images/bpc.jpg"),
                CatModel(Gender.Female, CatBreed.ExoticShorthair, "Misty", "Loves naps all day", "https://cdn2.thecatapi.com/images/8q2.jpg"),
                CatModel(Gender.Male, CatBreed.BalineseJavanese, "Shadow", "Quick and sneaky", "https://cdn2.thecatapi.com/images/9o3.jpg"),
                CatModel(Gender.Unknown, CatBreed.AmericanCurl, "Whiskers", "Always curious", "https://cdn2.thecatapi.com/images/abc.jpg"),
                CatModel(Gender.Female, CatBreed.ExoticShorthair, "Luna", "Queen of the house", "https://cdn2.thecatapi.com/images/def.jpg"),
                CatModel(Gender.Male, CatBreed.BalineseJavanese, "Max", "Hunter and jumper", "https://cdn2.thecatapi.com/images/ghi.jpg"),
                CatModel(Gender.Unknown, CatBreed.AmericanCurl, "Neko", "Mysterious wanderer", "https://cdn2.thecatapi.com/images/jkl.jpg")
            )
        )
    }
